...
const Pokemon = () => (
  <Page markSource={markdown} title="Pokemon Glacier and Aurora" sub="Battle for Freedom">
    <a style={{ margin: '20px 20px 0px 0px' }} href="https://drive.google.com/drive/folders/1XWk4K6T0ysrYlFmYyTXEcJNykNNRzlEj?usp=drive_link" className="button">Download</a>
